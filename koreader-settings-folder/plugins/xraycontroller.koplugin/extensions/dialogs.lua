...
local ConfirmBox = require("xrayviews/widgets/confirmbox")
local DocumentRegistry = require("document/documentregistry")
local FilesBox = require("xrayviews/widgets/filesbox")
local Font = require("modules/font")
local HtmlBox = require("xrayviews/widgets/htmlbox")
...
local NavigatorBox = require("xrayviews/widgets/navigatorbox")
local NiceAlert = require("xrayviews/widgets/nicealert")
local TextViewer = require("xrayviews/widgets/textviewer")
