...
local ConfirmBox = require("widgets/confirmbox")
local DocumentRegistry = require("document/documentregistry")
local FilesBox = require("widgets/filesbox")
local Font = require("modules/font")
local HtmlBox = require("widgets/htmlbox")
local ImageViewer = require("ui/widget/imageviewer")
local InfoMessage = require("widgets/infomessage")
local InputDialog = require("widgets/inputdialog")
local KOR = require("extensions/kor")
local MultiConfirmBox = require("widgets/multiconfirmbox")
local MultiInputDialog = require("widgets/multiinputdialog")
local NavigatorBox = require("widgets/navigatorbox")
local NiceAlert = require("widgets/nicealert")
local TextViewer = require("widgets/textviewer")
