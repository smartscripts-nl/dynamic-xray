...
function KOR:initDX()
	...
	DX.s = require("xraymodel/xraysettings")
	DX.s:setUp()
	if not DX.ex then
		DX.ex = require("xrayviews/xrayexporter")
	end
	DX.m = require("xraymodel/xraymodel")
	...
	local modules = {
		...
		oh = "xrayviews/xrayoccurrenceshistogram",
		b = "xrayviews/xraybuttons",
		cb = "xrayviews/xraycallbacks",
		--* this one must be loaded before XrayDialogs:
		ta = "xrayviews/xraytags",
		d = "xrayviews/xraydialogs",
		i = "xrayviews/xrayinformation",
		ip = "xrayviews/xrayinfopanel",
		p = "xrayviews/xraypages",
		q = "xrayviews/xrayquotes",
		sp = "xrayviews/xraysidepanels",
		u = "xrayviews/xrayui",
	}
	...
	if DX.m:isPublicDXversion() then
		DX.tm = require("xrayviews/xraytranslationsmanager")
	end
end
