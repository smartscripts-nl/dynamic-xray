...
function XrayDialogs:initViewHelpers()
    ...
    translations = require("xrayviews/xraytranslations")
...
function XrayDialogs:quickItemSearch()
    local pool = KOR.tables:shallowCopy(DX.vd.items)
...
function XrayDialogs:getItemProps(needle_item)
    ...
    local linked_items_info, linked_items_info2, linked_items_info3
    ...
    if linked_items then
        ...
        KOR.columntexts:initDisplayColumnsCount(#linked_items)
...
function XrayDialogs:generateOccurrencesHistogram(item)
    ...
    return DX.oh:generateChapterOccurrencesHistogram({
        ...
        container_width = Screen:getWidth() - 2 * Size.margin.default - Screen:scaleBySize(20),
