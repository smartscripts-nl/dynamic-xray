...
function XrayController:onDispatcherRegisterActions()
    ...
    Dispatcher:registerAction("show_main_xray_modules", { category = "none", event = "ShowXrayCenter", title = KOR.icons.lightning_bare .. " Show Xray Center", rolling = true })
    ...
    Dispatcher:registerAction("show_quizlet_questions", { category = "none", event = "ShowQuizletQuestions", title = DX.d:getControllerEntryName("Show Xray Quizlet-questions"), rolling = true })
...
function XrayController:onShowQuizletQuestions()
...
function XrayController:onShowXrayCenter()
    DX.d:showXrayCenter()
end
