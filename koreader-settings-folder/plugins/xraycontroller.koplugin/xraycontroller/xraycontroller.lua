...
function XrayController:onDispatcherRegisterActions()
    ...
    Dispatcher:registerAction("show_quizlet_questions", { category = "none", event = "ShowQuizletQuestions", title = DX.d:getControllerEntryName("Show Quizlet-questions"), rolling = true })
