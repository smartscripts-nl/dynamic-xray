...
if lfs_attributes(user_icons_dir, "mode") == "directory" then
    table_insert(ICONS_DIRS, 1, user_icons_dir)
end
...
--- @class IconWidgetActive
local IconWidgetActive = ImageWidgetActive:extend{
...
function IconWidgetActive:init()
