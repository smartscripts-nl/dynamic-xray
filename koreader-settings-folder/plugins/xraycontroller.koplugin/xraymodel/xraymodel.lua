...
function XrayModel:initDataHandlers()
    ...
    views_data = require("xraymodel/xrayviewsdata")
    page_navigator = require("xrayviews/xraypagenavigator")
    data_loader = require("xraymodel/xraydataloader")
    data_saver = require("xraymodel/xraydatasaver")
    forms_data = require("xraymodel/xrayformsdata")
    tapped_words = require("xraymodel/xraytappedwords")
