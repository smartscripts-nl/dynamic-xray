...
local VerticalScrollBar = InputContainer:extend{
    ...
    --* make the scollbar less in-our-face, instead of simple black:
    bordercolor = KOR.colors and KOR.colors.scrollbar_color or Blitbuffer.COLOR_LIGHT_GRAY,
    rectcolor = KOR.colors and KOR.colors.scrollbar_color or Blitbuffer.COLOR_LIGHT_GRAY,
    radius = 0,
