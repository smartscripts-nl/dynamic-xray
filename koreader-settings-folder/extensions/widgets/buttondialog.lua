...
function ButtonDialog:init()
    ...
    -- #((set button_dialog_table_width))
    --! this is needed to position the Page Navigator popup menu; consumed in ((MovableContainer#movePopupMenuToAboveParent)):
    KOR.registry:set("button_dialog_table_width", iwidth)
