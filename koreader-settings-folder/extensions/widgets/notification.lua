...
function Notification:_cleanShownStack()
    ...
    local count = #Notification._shown_list
    for i = count, 1, -1 do
...
function Notification:onShow()
    ...
    --* Alex: with timeout 0 you can let the notification stay until a click:
...
function Notification:onIgnoreTouchInput()
    return true
end
