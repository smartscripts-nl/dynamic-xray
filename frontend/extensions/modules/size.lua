...
local Size = {
    ...
    padding = {
        ...
        buttonvertical = Screen:scaleBySize(3),
        buttontable = Screen:scaleBySize(4),
        default = Screen:scaleBySize(5),
        titlebar = Screen:scaleBySize(7),
        titlebarbutton = Screen:scaleBySize(8),
        large = Screen:scaleBySize(10),
        fullscreen = Screen:scaleBySize(15),
        closebuttonpopupdialog = Screen:scaleBySize(20),
        outerfooterbutton = Screen:scaleBySize(26),
        extreme = Screen:scaleBySize(50),
    },
    radius = {
    ...
    item = {
        height_tiny = Screen:scaleBySize(5),
        height_small = Screen:scaleBySize(10),
    ...
    span = {
        ...
        vertical_small = Screen:scaleBySize(1),
