...
function ButtonTableGenerators:getVerticallyArrangedButtonTable(source_items, called_from_button, button_factory, info_button, close_button)
	local button_table = {}

	if info_button and not called_from_button then
