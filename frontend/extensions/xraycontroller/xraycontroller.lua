...
--! this class will be loaded in 2 locations: in the DX patch (for early initialisation of the KOR and DX systems) AND in plugins/xraycontroller.koplugin/main.lua:
