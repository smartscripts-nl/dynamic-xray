...
local ScrollTextWidget = InputContainer:extend{
    ...
    justified = false,
    line_height = nil,
    --* to keep the text farther away from the scrollbar:
    padding_right = 0,
    lang = nil,
...
function ScrollTextWidget:init()
    ...
    self.text_widget = TextBoxWidget:new{
        text = self.text,
        line_height = self.line_height or 0.13,
...
function ScrollTextWidget:onPanReleaseText()
...
function ScrollTextWidget:onScrollUpWithShiftSpace()
    return self:onScrollUp()
end
