...
function FrameContainer:paintTo(bb, x, y)
    ...
    if self.readonly and self.readonly_inverted then
        self.color = Blitbuffer.COLOR_WHITE
    elseif self.readonly then
        -- very light gray frame border:
    ...
    if self.bordersize > 0 then
        ...
        elseif bb.paintScreensaver then
            bb:paintScreensaver(0, y + self.margin,
                    container_width - self.margin,
                    container_height - self.margin * 2,
